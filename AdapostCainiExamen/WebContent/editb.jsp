...
<title>Editare lista beneficiari</title>
						...
						<div class="col-lg-12">
							<div class="card card-primary card-outline">
								...
								<div class="card-body">
									...
									<h1>Editare lista</h1>
<form:form action="${pageContext.request.contextPath}/editare-beneficiari-save.htm" method="post" modelAttribute="beneficiariForm">
<div class="form-group">
<label for="id">ID</label>
<form:input path="id" readonly = "true" class ="form-control"/><br/></div>
<div class="form-group">
...
<form:input path="caineID" class ="form-control"/><br/></div>
<input class="btn btn-primary" type="submit" value="Salveaza"/><br/>
</form:form>
</br>

<a href="<c:url value="/listCaini.htm"/>">Inapoi la lista</a>
